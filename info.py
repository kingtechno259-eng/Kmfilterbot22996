...
API_ID = int(environ.get('API_ID', '24799187'))
API_HASH = environ.get('API_HASH', '4baef40b8f24b66a25ccd232861186ed')
BOT_TOKEN = environ.get('BOT_TOKEN', "8730310259:AAGNsWEKMrnmU99m61zzHS374k1HJ7aLIYY")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://graph.org/file/7c4850dc9ac6ebb2d39fb-ec3cfc3f2b064d1b8f.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '777000').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003608642564'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003722778120')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Kingkishan:22996@cluster0.jpobaxp.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/169d21f1a50bb4f34a387-524467302bc984cc73.jpg') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/EpicCastle')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/EpicCastle')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'EpicCastle') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/kingKN01')
